...
public class Card_G : MonoBehaviour {
	...
	public CardGDefinition def;  // from DeckXML.xml		
...
[System.Serializable]
public class CardGDefinition{
	public string	face;	//sprite to use for face cart
	public int		rank;	// value from 1-13 (Ace-King)
	public List<Decorator_G>	
					pips = new List<Decorator_G>();  // Pips Used
}
