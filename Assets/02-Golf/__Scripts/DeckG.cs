...
public class DeckG : MonoBehaviour {
...
[Header("Set in Inspector")]
	...
	public void ReadDeck(string deckgXMLText)
	{
		...
		s += "type=" + xmlr.xml ["xml"] [0] ["decoratorg"] [0].att ("type");
		s += " x=" + xmlr.xml ["xml"] [0] ["decoratorg"] [0].att ("x");
		s += " y=" + xmlr.xml ["xml"] [0] ["decoratorg"] [0].att ("y");
		s += " scale=" + xmlr.xml ["xml"] [0] ["decoratorg"] [0].att ("scale");
		print (s);
		...
		PT_XMLHashList xDecos = xmlr.xml["xml"][0]["decoratorg"];
		Decorator deco;
