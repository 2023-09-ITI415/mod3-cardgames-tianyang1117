...
using UnityEngine;
// The SlotDef class is not a subclass of MonoBehaviour, so it doesn't
// a separate C# file.
[System.Serializable] // This makes SlotDefs visible in the Unity

public class SlotDef_G
{
    public float x;
    public float y;
...
public class Layout_G : MonoBehaviour
{
    ...
    public Vector2 multiplier; // The offset of the tableau's center
                               // SlotDef references
    public List<SlotDef_G> slotDefs; // All the SlotDefs for Row0-Row3
    public SlotDef_G drawPile;
    public SlotDef_G discardPile;
...
"Row2", "Row3", "Row4", "Discard", "Draw" };
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        {
            tSD = new SlotDef_G(); // Create a new SlotDef instance
