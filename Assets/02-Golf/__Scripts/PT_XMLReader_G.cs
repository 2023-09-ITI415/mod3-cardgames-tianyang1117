...
public class PT_XMLHashList_G {
	public ArrayList list = new ArrayList();
	
	public PT_XMLHashtableG this[int s] {
		get {
			return(list[s] as PT_XMLHashtableG);
		}
		set {
			list[s] = value;
		}
	...
	public void Add(PT_XMLHashtableG eH) {
		list.Add(eH);
	}
