...
public class ScoreManager_G : MonoBehaviour
{ // a
    static private ScoreManager_G S; // b
    ...
    static public void EVENT(eScoreEventG evt)
    { // d
        try
